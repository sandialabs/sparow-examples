#
# Setup BUS-9_ALPHA-1~1.2_GROWTH-1.0_REP-4_FIDELITY-DC_RELAX-RSS~None_COMMITMENT-4
#
# 
# 
...
module_root = string.Template(
    """
# sparow_examples.organized_gtep_runs.B9
...
model_data = {"scenarios": [{"ID": "low_alpha", "Demand": 1.0, "Probability": 0.5,"alpha":1.0,"PF":"DC"},{"ID": "high_alpha", "Demand": 1.0, "Probability": 0.5,"alpha":1.2,"PF":"DC"}]}
