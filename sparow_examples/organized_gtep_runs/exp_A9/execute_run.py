...
try:
    from sparow_examples.organized_gtep_runs.exp_A9 import create_sp

    dummy_available = True
except:
    dummy_available = False

relaxations = {'scenario_A': {'relax_second_stage': False, 'unit_commitment': True}, 'scenario_B': {'relax_second_stage': False, 'unit_commitment': True}}
