# sparow_examples.organized_gtep_runs.exp_A9

from sparow.sp import stochastic_program
import importlib


app_data = {'stages': 3, 'len_reps': 1, 'num_dispatch': 1}
model_data = {'scenarios': [{'ID': 'scenario_A', 'Demand': 1.0, 'Probability': 0.5, 'alpha': 1.0, 'PF': 'CP', 'num_reps': 4, 'num_commit': 4}, {'ID': 'scenario_B', 'Demand': 1.0, 'Probability': 0.5, 'alpha': 1.2, 'PF': 'DC', 'num_reps': 4, 'num_commit': 4}]}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.organized_gtep_runs.exp_A9." + data["ID"]
    )
