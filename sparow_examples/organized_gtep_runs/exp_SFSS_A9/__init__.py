# sparow_examples.organized_gtep_runs.exp_SFSS_A9
...
model_data = {'scenarios': [{'ID': 'scenario_A', 'Demand': 1.0, 'Probability': 1.0, 'alpha': 1.0, 'PF': 'CP', 'num_reps': 12, 'num_commit': 4}]}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.organized_gtep_runs.exp_SFSS_A9." + data["ID"]
    )
