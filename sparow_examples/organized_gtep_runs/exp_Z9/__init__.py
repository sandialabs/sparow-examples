# sparow_examples.organized_gtep_runs.exp_Z9

from sparow.sp import stochastic_program
import importlib


app_data = {'stages': 3, 'num_reps': 2, 'len_reps': 1, 'num_commit': 12, 'num_dispatch': 1}
model_data = {'scenarios': [{'ID': 'scenario_A', 'Demand': 1.0, 'Probability': 0.5, 'alpha': 1.0, 'PF': 'CP'}, {'ID': 'scenario_B', 'Demand': 1.0, 'Probability': 0.5, 'alpha': 0.8, 'PF': 'DC'}]}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.organized_gtep_runs.exp_Z9." + data["ID"]
    )
