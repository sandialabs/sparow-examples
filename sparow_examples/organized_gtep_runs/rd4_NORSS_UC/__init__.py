# sparow_examples.organized_gtep_runs.rd4_NORSS_UC
...
model_data = {'scenarios': [{'ID': 'scenario_A', 'Demand': 1.0, 'Probability': 1.0, 'alpha': 1.0, 'PF': 'DC', 'num_reps': 4, 'num_commit': 24, 'include_commitment': True}]}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.organized_gtep_runs.rd4_NORSS_UC." + data["ID"]
    )
