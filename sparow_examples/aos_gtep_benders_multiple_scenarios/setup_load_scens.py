#
# Setup multi-scenario GTEP scale-tests under aos_gtep_benders_multiple_scenarios
#
# Generates scale_tests/ with two scenario packages that differ only by alpha.
#
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.aos_gtep_benders_multiple_scenarios.$name." + data["ID"]
    )
