# sparow_examples.bus_123.test_gtep
...
model_data = {'scenarios': [{'ID': 'scenario_A', 'Demand': 1.0, 'Probability': 1.0, 'alpha': 1.0, 'PF': 'CP', 'num_reps': 1, 'num_commit': 1, 'include_commitment': True}]}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.bus_123.test_gtep." + data["ID"]
    )
