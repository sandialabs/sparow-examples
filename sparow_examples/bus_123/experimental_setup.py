...
try:
    from sparow_examples.bus_123.{experimental_name} import create_sp
...
'''
    ...
    experiment_init_content = f'''# sparow_examples.bus_123.{experimental_name}
...
def model_builder(data, args):
    ...
    scenario = importlib.import_module(
        "sparow_examples.bus_123.{experimental_name}." + data["ID"]
    )
