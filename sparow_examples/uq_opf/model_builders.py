...
def _build_multitime_model(data, single_period_builder, load_mismatch_cost, q_load_mismatch_cost=None, add_ramping=False):
    ...
    for time in fm.time_periods:
        ...
        fm.time_periods[time].m, md = single_period_builder(model_data, include_feasibility_slack=True)
